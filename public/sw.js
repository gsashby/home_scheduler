...
// don't fit that cleanly). Two jobs: (1) offline read access to the app shell
// per NFR #6, (2) display web push notifications for the daily brief,
// deadline alerts, and parent nudges per Must-have #10.
